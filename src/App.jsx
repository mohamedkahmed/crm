...
import {Home,Mediator, Updateemployeer,UpdateProject ,Client, Administration, UpdatePowers, Calendar, Employees, Expenses, Invoices, Mission, Powers, Projects, Reports, SharedLayout, SingleProject, ReportDetails} from "./pages/dashboard";
import { AddEmployees ,AddProject, AddPower, AddClient, AddMediator, AddInvoices } from "./components";
...
<Route path="updatePowers/:id" element={<UpdatePowers/>}/>
</Route>
